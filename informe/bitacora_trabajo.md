...
| Clasificacion | Modelo de abandono de clientes y exportacion de predicciones. | `notebooks/03_clasificacion.ipynb` | Pendiente | Se compararan al menos tres modelos. |
